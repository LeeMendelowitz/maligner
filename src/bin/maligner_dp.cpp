...
namespace opt
{
    ...
    static int ref_max_misses = 3;
    static double sd_rate = 0.10;
    static double min_sd = 1000.0;
    static double max_chunk_sizing_error = 16;
    static int alignments_per_reference = 2;
    static int min_alignment_spacing = 10;
    static int neighbor_delta = 0;
    static bool query_is_bounded = true;
...
int main(int argc, char* argv[]) {
  ...
  AlignOpts align_opts(opt::query_miss_penalty,
                       opt::ref_miss_penalty,
                       opt::query_max_misses,
                       opt::ref_max_misses,
                       opt::sd_rate,
                       opt::min_sd,
                       opt::max_chunk_sizing_error,
                       opt::alignments_per_reference,
                       opt::min_alignment_spacing,
                       opt::neighbor_delta,
                       opt::query_is_bounded,
                       opt::ref_is_bounded);
  ...
  for(auto i = ref_maps.begin(); i != ref_maps.end(); i++) {
    map_db.insert( MapWrapperDB::value_type(i->name_, MapWrapper(*i, opt::ref_max_misses)) );
  }
